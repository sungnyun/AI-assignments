...
OPT2=$(basename $CODE_DIR2)
OPT3=$(basename $CODE_DIR3)
...
bayesmark-launch -dir $DB_ROOT -b $DBID -n $N_STEP -r $N_REPEAT -p $N_BATCH -o RandomSearch $OPT $OPT2 $OPT3 --opt-root $OPT_ROOT -v -c RF MLP-adam MLP-sgd ada -d boston diabetes wine iris
