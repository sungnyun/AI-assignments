...
bayesmark-launch -dir $DB_ROOT -b $DBID -n $N_STEP -r $N_REPEAT -p $N_BATCH -o RandomSearch $OPT $OPT2 $OPT3 $OPT4 --opt-root $OPT_ROOT -v -c SVM -d boston
