...
import sys
sys.path.insert(0, "/home/jaeyeon/jupyter/BBO/gitrepo/custom_turbo/")
...
#         rescaled_data = mas.fit_transform(data_points)        
    ...
    def restart(self):
        ...
        if self.initiated is False: # when initiating
            ...
            self.selected_label = self.classifier.predict(self.turbo.X[self.turbo.fX.argmin().item()][None,:]) 
